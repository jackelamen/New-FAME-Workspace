...
const CommerceEngine: React.FC<CommerceEngineProps> = ({ onContactClick }) => {
  ...
  return (
    <div className="relative pt-24 md:pt-32 pb-0 overflow-hidden bg-[#05070a]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-16 md:mb-24 gap-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-3xl text-white/50 font-light leading-relaxed">
              We don’t just talk; we help you <span className="text-white font-bold italic">reach your customers.</span> From physical shops to online stores, we make sure you have everything you need to succeed.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
          ...
          <div className="group bg-gradient-to-b from-white/[0.03] to-transparent p-10 md:p-16 rounded-[3rem] border border-white/5 hover:border-orange-500/20 transition-all duration-700">
            ...
            <p className="text-white/40 text-lg md:text-xl font-light mb-12 leading-relaxed">
              We help premium food and lifestyle brands get into the best stores and online shops. We handle the hard work of <span className="text-white/80 font-bold italic">sales and marketing</span> so you can focus on creating.
            </p>
          ...
          {/* Strategic Tech Side */}
          <div className="group bg-white/[0.02] p-10 md:p-16 rounded-[3rem] border border-white/5 relative overflow-hidden flex flex-col justify-between">
            <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 blur-[100px] rounded-full pointer-events-none"></div>
            
            <div>
              <div className="flex justify-between items-start mb-12">
                <h3 className="text-3xl md:text-5xl font-black uppercase tracking-tight">Smart <br />Tools</h3>
              </div>
              <p className="text-white/40 text-lg md:text-xl font-light mb-12 leading-relaxed">
        ...
        <div className="mt-16 md:mt-24 p-8 md:p-12 glass-card rounded-[2.5rem] border border-white/10 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-center md:text-left">
            <h4 className="text-2xl font-black uppercase tracking-tight mb-2">Ready to Grow your Business?</h4>
            <p className="text-white/40 uppercase text-[10px] tracking-[0.4em] font-bold">Ask us about how we can work together</p>
          </div>
          <button 
