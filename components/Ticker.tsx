...
const Ticker: React.FC = () => {
  ...
  return (
    <div className="relative py-6 bg-orange-600/5 border-y border-white/5 overflow-hidden whitespace-nowrap">
          ...
          <div key={i} className="flex items-center">
            {tickerItems.map((item, idx) => (
              <React.Fragment key={idx}>
                ...
                <span className="w-1.5 h-1.5 rounded-full bg-orange-500/30"></span>
              </React.Fragment>
            ))}
          </div>
        ))}
