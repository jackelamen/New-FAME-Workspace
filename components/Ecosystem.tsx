          ...
          <div className="space-y-12">
            {steps.map((step, i) => (
              <div key={i} className="flex gap-8 group">
                <span className="text-2xl font-black text-white/10 group-hover:text-[#40E0D0] transition-colors">0{i + 1}</span>
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight mb-2 group-hover:text-[#40E0D0] transition-colors">{step.title}</h3>
