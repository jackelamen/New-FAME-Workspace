    ...
    <div className="max-w-7xl mx-auto">
      <div className="space-y-16 md:space-y-24">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-4 text-[#ff4d00] text-[11px] font-black uppercase tracking-[0.5em] mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-start">
          <div className="space-y-8">
            <p className="text-white/90 text-2xl md:text-3xl font-light leading-snug">
              Headquartered in <span className="text-white font-black underline decoration-[#ff4d00] decoration-2 underline-offset-8">Seoul, South Korea,</span> FAME Entertainment Group operates as a specialized lifestyle trading house and creative agency.
            </p>
          ...
          <div className="space-y-8 border-l border-white/10 pl-0 lg:pl-12">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              {['Seoul', 'Tokyo', 'Los Angeles', 'New York'].map((location) => (
                <div key={location} className="px-5 py-2.5 bg-white/5 rounded-full border border-white/5 hover:border-orange-500/30 transition-colors">
