  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-32 pb-20 bg-[#fdfcfb]">
      ...
      <div className="relative z-10 w-full max-w-[90rem] mx-auto px-6 text-center">
        <div className="flex flex-col items-center justify-center space-y-0 text-[#05070a]">
        ...
        <div className="mt-12 md:mt-20 max-w-2xl mx-auto">
          <p className="text-lg md:text-2xl text-[#05070a]/50 font-medium tracking-tight leading-relaxed">
        ...
        <div className="mt-16 md:mt-24 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
          <a href="#about" className="w-full sm:w-auto px-16 py-6 bg-[#05070a] text-white font-black uppercase text-[12px] tracking-[0.2em] rounded-full hover:bg-[#40E0D0] hover:text-[#05070a] transition-all transform hover:-translate-y-1 active:scale-95 shadow-2xl shadow-[#05070a]/10">
            Who We Are
          </a>
          <a href="#pillars" className="w-full sm:w-auto px-16 py-6 border border-[#05070a]/20 text-[#05070a] font-black uppercase text-[12px] tracking-[0.2em] rounded-full hover:bg-[#05070a] hover:text-white transition-all transform hover:-translate-y-1 active:scale-95">
            What We Do
          </a>
        </div>
      </div>
      ...
      {/* Visual Border Guide */}
      <div className="absolute inset-x-10 top-[25%] bottom-[20%] border border-dashed border-[#05070a]/5 rounded-xl pointer-events-none hidden lg:block"></div>
    </div>
  );
};
